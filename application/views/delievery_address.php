...
<div class="col-lg-6 mt-2" id="<?=$address->id?>">
    <div class="card mb-lg-0">
        ...
        <div class="card-body">
           <address><?= $address->address_line_1.' '.$address->address_line_2.' '.$address->address_line_3.' '.$address->city.' '.$states->name.' '.$address->country.' , '.$address->pincode ; ?></address>
